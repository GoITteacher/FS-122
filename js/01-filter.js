...
// [10, 20]
// const arr = numbers.filter((el, idx) => el % 2 === 0);
// console.log(arr);

// numbers.filter(el => el > 10);
// numbers.filter(el => el < 5);
// numbers.filter(el => {
//   if (el.toString().includes('5')) {
//     return true;
//   } else {
//     return false;
//   }
...
// allCars.filter(car => car.make === 'Ford');
// allCars.filter(car => car.price > 10000);
// allCars.filter(car => car.onSale === true);
// const res = allCars.filter(car => car.type === 'sedan');

// const res = allCars.find(car => {
//   const isSedan = car.type === 'sedan';
//   const isExpensive = car.price > 1000;
//   const onSale = car.onSale === true;
//   return isSedan && isExpensive && onSale;
// });

// console.log(res);

// const res = allCars.find(car => car.price > 5000);
// const res = allCars.findIndex(car => car.price > 5000);
// const res = allCars.filter(car => car.price > 5000);
// const res = allCars.some(car => car.price > 5000);
// const res = allCars.every(car => car.price > 5000);
